            ...
            <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                <div>
                    <h1
                        ...
                        Start your journey with <span class="text-blue-600">ShoesStore</span></h1>
                    <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">Purchase a wide variety of footwear
                        products like Sneakers, Sandals, Boots, Formal Shoes, and many more.</p>
                ...
                <div class="relative ms-4">
                    <img class="w-full rounded-md" src="{{ asset('images/Shoes.svg') }}" alt="Image Description">
                    <div
        ...
        <div class="max-w-xl mx-auto">
            <div class="text-center ">
                ...
                <p class="mb-12 text-base text-center text-gray-500">
                    Discover top footwear brands known for quality, style, and comfort. Shop from leading names in
                    sneakers, formal shoes, boots, and more!
                </p>
            </div>
        </div>
    ...
    <div class="bg-orange-200 py-20">
        <div class="max-w-xl mx-auto">
            <div class="text-center ">
                ...
                <p class="mb-12 text-base text-center text-gray-500">
                    Explore a wide range of footwear categories, from stylish sneakers and formal shoes to durable boots
                    and comfortable sandals. Find the perfect pair for every occasion!
                </p>
            </div>
        </div>
                            ...
                            <div class="flex justify-between items-center">
                                <div class="flex items-center">
                                    <img class="h-[2.375rem] w-[2.375rem] rounded-full"
                                        src="{{ asset('storage/' . $category->image) }}" alt="Image Description">
                                    <div class="ms-3">
                                        <h3
