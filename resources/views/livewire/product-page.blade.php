                            ...
                            @foreach ($categories as $category)
                                <li class="mb-4" wire::key="{{ $category->id }}">
                                    <label for="{{ $category->slug }}" class="flex items-center dark:text-gray-400 ">
                                        <input type="checkbox" wire:model.live="selected_categories" class="w-4 h-4 mr-2" value="{{ $category->id }}">
                                ...
                                <div class="border border-gray-300 dark:border-gray-700">
                                    <div class="relative bg-gray-200">
                                        <a href="/products/{{ $product->slug }}" class="">
                                            <img src="{{ $product->image ? asset('storage/' . $product->image[0]) : 'https://placehold.co/400'  }}" alt=""
                                                class="object-cover w-full h-56 mx-auto ">
                                        </a>
                                    </div>
                                    <div class="p-3 relative h-28">
